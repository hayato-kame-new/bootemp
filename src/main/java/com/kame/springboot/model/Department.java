...
public class Department {
	...
	private String departmentId;  // 新規の時には、nullで渡っていくので、バリデーションを@NotEmpty を付けない
	...
	// こっちは、親テーブル側です。必要なら、子テーブル側にcascadeを書きますが、  cascade必要なければ付けない 今回は、子テーブルのemployeeのデータを全て消しても、Departmentは残したいので、子テーブル側にはcascadeはつけません
	@OneToMany 
